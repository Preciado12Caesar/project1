<?php
// admin/tipos_create.php - Crear nuevo tipo de maquinaria
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            // Verificar si ya existe un tipo de maquinaria con ese nombre en la misma subcategoría
            ...
            if ($result['total'] > 0) {
                $status_message = "Ya existe un tipo de maquinaria con ese nombre en la subcategoría seleccionada.";
                $status_type = "danger";
                ...
                // Insertar nuevo tipo de maquinaria
                ...
                $status_message = "Tipo de maquinaria creado correctamente.";
                $status_type = "success";
...
<div class="container-fluid py-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-truck me-2"></i>Nuevo Tipo de Maquinaria
        </h1>
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <button type="submit" class="btn btn-primary">Guardar Tipo de Maquinaria</button>
                </div>
            </form>
        </div>
    </div>
